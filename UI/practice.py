...
frame = ttk.Frame(first_window, padding="40 40 40 40")
...
name_label = ttk.Label(frame, text="What are you doing")
...
about_entry = ttk.Entry(frame, width=50, textvariable=about_text, state="readonly")
